...
<#--            <label class="layui-form-label"><span class="span_must">*</span></label>-->
            ...
            <div class="layui-input-normal">
                <input type="text"  name="ywlsh" maxlength="255" lay-verify="required"
                 value="${(model.ywlsh)!""}"  placeholder="请输入业务流水号"  class="layui-input" readonly>
            </div>
        </div>
            ...
            <div class="layui-input-normal">
                <input type="text"  name="dwzh" maxlength="255" lay-verify="required"
                 value="${(model.dwzh)!""}"  placeholder="请输入汇缴的单位账号"  class="layui-input" readonly>
            </div>
        </div>
            ...
            <div class="layui-input-normal">
                <input type="text"  name="money" maxlength="255,0" lay-verify="required"
                 value="${(model.money)!""}"  placeholder="请输入单位的汇缴额"  class="layui-input" readonly>
            </div>
        </div>
            ...
            <div class="layui-input-normal">
                <input type="text"  name="jcdate" maxlength="20" lay-verify="required" readonly
                 value="${(model.jcdate)!""}"  placeholder="${(model.jcdate)}"  class="layui-input">
            </div>
        </div>
            ...
            <div class="layui-input-normal">
                <input type="text"  name="jcrs" maxlength="255" lay-verify="required"
                 value="${(model.jcrs)}"  placeholder="请输入单位缴存人数"  class="layui-input" readonly>
            </div>
        </div>
